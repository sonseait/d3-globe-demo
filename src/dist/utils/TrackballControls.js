...
const DISABLED_VERTICAL_ROTATE = true;
...
export const TrackballControls = function (object, domElement) {
  ...
  this.rotateCamera = (function () {
    ...
    return function rotateCamera() {
      const amountY = DISABLED_VERTICAL_ROTATE ? 0 : _moveCurr.y - _movePrev.y;

      moveDirection.set(_moveCurr.x - _movePrev.x, amountY, 0);
      ...
      if (angle) {
        ...
        objectSidewaysDirection
          ...
          .normalize();
        objectUpDirection.setLength(amountY);
